EpubFetch.ContentTypeDiscovery = Backbone.Model.extend({
    ...
    identifyContentType: function () {
        ...
        if (contentType === null) {
            ...
            console.log('guessed contentType [' + contentType + '] from URI ['
                + contentUrl + ']. Configuring the web server to provide the content type is recommended.');
