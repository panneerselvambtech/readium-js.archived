...
def gen_readium_js(template_file_path, output_file_path)

  puts "generating ReadiumJs"
...
# TODO: Alter this for changes in the Readium.js project
...
task :build do
    ...
    gen_readium_js("epub-modules/readium-js/readium_js_template.js.erb", "epub-modules/development/Readium.js")
    puts "=> Readium.js"
